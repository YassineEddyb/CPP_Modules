...
Form::Form(): _name("Form"), _is_signed(false), _sign_grade(GRADE_MAX), _execute_grade(GRADE_MAX)  {
...
Form::Form(const Form& obj): _name("Form"), _sign_grade(GRADE_MAX), _execute_grade(GRADE_MAX) {
    *this = obj;
}
