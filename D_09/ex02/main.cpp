...
//     start = clock();
//     s.sortVector(0, argc - 2, 2);
//     finish = clock();
//     time_v = ((double) (finish - start)) / CLOCKS_PER_SEC;

//     start = clock();
//     s.sortDeque(0, argc - 2, 2);
//     finish = clock();
...
//     std::cout << "Time to process a range of 3000 elements with std::vector " <<  std::fixed << time_v << std::endl;
//     std::cout << "Time to process a range of 3000 elements with std::deque " <<  std::fixed << time_dq << std::endl;
